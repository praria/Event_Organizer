const payloads = [    
    ...
    [
      ...
      {"event_type": "accident", "priority": "High", "description": "Guest feeling nauseous after eating undercooked meat"}, 
      {"event_type": "bride", "priority": "High", "description": "Missing groom's ring moments before the ceremony"}, 
      ...
      {"event_type": "dirty_floor", "priority": "Medium", "description": "Photographer's assistant forgot to bring extra batteries"}, 
      {"event_type": "accident", "priority": "Medium", "description": "Dirty footprints noticed on the dance floor"}, 
      {"event_type": "accident", "priority": "Low", "description": "Photographer's assistant forgot to bring extra batteries"}, 
      {"event_type": "bad_food", "priority": "Medium", "description": "Wrong song played during first dance"}, 
